    ...
    <div id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
      ...
      >
        <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer">
          Продавайте на Алиэкспресс
        </li>
        <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer">
          Cookie Preferences
        </li>
        <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer">Помощь</li>
        <li class="border-r border-r-gray-400 px-3 hover:text-[#FF4646] cursor-pointer">
          Защита покупателей
        </li>
        ...
        >
          ...
          <div
            id="AccountMenu"
            v-if="isAccountMenu"
            class="absolute bg-white w-[213px] text-[#333333] z-40 top-[38px] -left-[100px] border-x border-b"
          >
            <div v-if="true">
              <div class="text-semibold text-[15px] my-4 px-3">Добро пожаловать!</div>
            ...
            <ul class="bg-white">
              ...
              <li v-if="true" class="text-[13px] py-2 px-4 w-full hover:bg-gray-200">Выход</li>
            </ul>
          </div>
        </li>
      </ul>
        ...
        <div class="max-w-[700px] w-full md:block hidden">
          <div class="relative">
            <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
              <input
                class="w-full placeholder-type-400 text-sm pl-3 focus:outline-none"
                type="text"
                v-model="searchItem"
              />
