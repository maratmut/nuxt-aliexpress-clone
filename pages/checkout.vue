      ...
      <div class="md:flex gap-4 justify-between mx-auto w-full">
        ...
        <div class="md:w-[35%]">
          <div id="PlaceOrder" class="bg-white rounded-lg p-4">
            <div class="text-2xl font-extrabold mb-2">Мои покупки</div>
          ...
          <div class="bg-white rounded-lg p-4 mt-4">
            ...
            <p class="my-2">AliExpress обеспечивает безопасность вашей информации и платежей</p>
          </div>
        </div>
      </div>
    </div>
