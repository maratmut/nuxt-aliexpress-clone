    ...
    <div id="ShoppingCartPage" class="mt-4 max-w-[1200px] mx-auto px-2">
      <div v-if="false" class="h-[500px] flex items-center justify-center">
        <div class="pt-20">
          ...
          <div class="text-xl text-center mt-4">Еще нет товаров?</div>
      ...
      <div v-else class="md:flex gap-4 justify-between mx-auto w-full">
        <div class="md:w-[65%]">
          <div class="bg-white rounded-lg p-4">
            <div class="text-2xl font-bold mb-2">Корзина товаров (0)</div>
          </div>
          <div class="bg-[#EEEEEE] rounded-lg p-4 mt-4">
            <div class="text-red-500 font-medium">
              Приветственное предложение распространяется на 1 товар
            </div>
          </div>
        ...
        <div class="md:w-[35%]">
          <div id="Summary" class="bg-white rounded-lg p-4">
            <div class="text-2xl font-extrabold mb-2">Перечень товаров</div>
          ...
          <div id="PaymentProtection" class="bg-white rounded-lg p-4 mt-4">
            <div class="text-lg font-semibold mb-2">Способ оплаты</div>
